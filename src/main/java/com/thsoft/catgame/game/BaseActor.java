 ...
 * 
 * @author Lee Stemkoski, and Taras Hopka (some metods)
 */
public class BaseActor extends Group {
	...
	/**
	 * Set rectangular-shaped collision polygon. This method is automatically called
	 * when animation is set, provided that the current boundary polygon is null.
	 * 
	 * @see #setAnimation
	 */
	 ...
	 * Note: one vertex will be located at point (0,width); a 4-sided polygon will
	 * appear in the orientation of a diamond.
	 * 
	...
	/**
	 * Retrieves a list of all instances of the object from the given stage with the
	 * given class name or whose class extends the class with the given name. If no
	 * instances exist, returns an empty list. Useful when coding interactions
	 * between different types of game objects in update method.
	 * 
	 * @param stage    Stage containing BaseActor instances
	 * @param theClass
	 * @return list of instances of the object in stage which extend with the given
	 *         class name
	 */
	 ...
	 * 
	 * @param stage     screane thrt containet object
	...
	/**
	 * made Taras Hopka class to set BoundaryPolygon from pading( in pixel) four
	 * sides
	 * 
	 * @see #boundaryPolygon
	 * @param left   padding from left side
	 * @param right  padding from right side
	 * @param top    padding from top
	 * @param bottom padding from bottom
	 */
	public void setBoundaryPolygon(int left, int right, int top, int bottom) {
