...
/**
 * клас для пускової установки і ліннії навдення
 * 
 * @author Taras Hopka 2019
 */
public class LaunchigPad extends BaseActor {
	/**
...
//	float sizeX;
	...
	public LaunchigPad(int maxSpead, int minSpead, int maxAngle, int minAngle, float x, float y, Stage s) {
		super(x, y, s);
